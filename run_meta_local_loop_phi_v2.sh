...
# wandb
export WANDB_PROJECT=xukp20-$DATASET-local-loop-v2

UPDATE_STYLE=$1
LOOP_LAYERS=$2
LOOP_TIMES=$3

RUN_NAME=${UPDATE_STYLE}_${LOOP_LAYERS}_loop${LOOP_TIMES}
if [ -z $RUN_NAME ]; then
    RUN_NAME_PAR=""
else
...
export CUSTOM_MODEL_PATH="/cephfs/xukangping/code/LLaMA-Efficient-Tuning/load_my_model_v2.py"

export MODEL_PATH=$MODEL_NAME_OR_PATH
export UPDATE_STYLE=$UPDATE_STYLE

...
if [ $RUN_NAME == "cov_1_001_all" ]; then
    ...
    RESUME_FROM_CHECKPOINT=/cephfs/xukangping/root/models/xukp20-metamathQA-mistral-e3/alpaca-metamathQA-05-27-09-49/checkpoint-9000
    OUTPUT_DIR=/cephfs/xukangping/root/models/xukp20-metamathQA-mistral-e3/alpaca-metamathQA-05-27-09-49
fi
